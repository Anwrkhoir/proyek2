...
@section('content')
    ...
    <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            ...
            <form method="POST" action="{{ route('management_produk.update_menu', ['id' => $produk->id]) }}"
              ...
              Displayed on public forums, such as
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <input value="{{ $produk->nama_produk }}" name="name" id="af-account-full-name"
                                type="text"
                    ...
                    <div class="sm:col-span-9">
                        <input value="{{ $produk->harga }}" id="af-harga" name="harga" type="number"
              ...
              (Optional)
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            ...
                            <select name="kategori_id"
                                class="py-2 px-3 pr-9 block w-full sm:w-auto border-gray-200 shadow-sm -mt-px -ml-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-l-lg sm:mt-0 sm:first:ml-0 sm:first:rounded-tr-none sm:last:rounded-bl-none sm:last:rounded-r-lg text-sm relative focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                                <option disabled>Pilih</option>
                                <option {{ $produk->kategori_id == '1' ? 'selected' : '' }} value="1">Makanan</option>
                                <option {{ $produk->kategori_id == '2' ? 'selected' : '' }} value="2">Minuman</option>
                            </select>
                    ...
                    <div class="sm:col-span-9">
                        <textarea name="detail" id="af-account-bio"
                            ...
                            rows="6" placeholder="Tuliskan komposisi produk...">
                        {{ $produk->detail }}
                        </textarea>
                    </div>
                    <!-- End Col -->
